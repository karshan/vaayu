...
#define NUM_LEDS 32
volatile u8 button_state[BUTTON_ROWS][BUTTON_COLS]; // if more than 8 rows u8 will need to become u16
volatile u8 led_state[NUM_LEDS][3]; // GRB
volatile u8 flush_leds = 0;
